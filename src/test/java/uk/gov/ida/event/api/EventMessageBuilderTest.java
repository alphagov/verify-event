...
public class EventMessageBuilderTest {
    ...
    public void build() {
        ...
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().build();
    ...
    public void shouldUpdateEventId() {
        ...
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().withEventId(eventId).build();
    ...
    public void shouldUpdateTimestamp() {
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().withTimestamp(TIMESTAMP).build();
    ...
    public void shouldUpdateOriginatingService() {
        ...
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().withOriginatingService(originatingService).build();
    ...
    public void shouldUpdateSessionId() {
        ...
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().withSessionId(sessionId).build();
    ...
    public void shouldUpdateDetails() {
        ...
        final EventMessage eventMessage = EventMessageBuilder.anEventMessage().withDetails(details).build();
